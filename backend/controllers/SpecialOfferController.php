...
class SpecialOfferController extends \yii\web\Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => SpecialOffer::find()->orderBy(['created_at' => SORT_DESC]),
        ]);
    ...
    public function actionDelete($id)
    {
        if ($model = $this->findModel($id)) {
            $model->status_id = SpecialOffer::STATUS_DELETED;
            if ($model->save())
    ...
    {
        if (($model = SpecialOffer::findOne($id)) !== null) {
            return $model;
        }
